...
class VOLUMERUNTIME_API UVdbVolume : public UVdbVolumeBase
{
...
public:
	...
	UVdbVolume();
	virtual ~UVdbVolume();
	UVdbVolume(FVTableHelper& Helper);
	...
	FVolumeRenderInfos& GetRenderInfos() { return VolumeRenderInfos; }
